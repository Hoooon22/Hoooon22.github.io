...
| 버전 | 날짜 | 변경 내용 |
|:-----|:-----|:----------|
| **v1.0.7** | 2025.01.19 | 자동 업데이트 → 수동 다운로드 링크로 변경 |
| **v1.0.6** | 2025.01.19 | 명령어 편집 기능 추가 (자동완성 지원) |
| **v1.0.5** | 2025.01.19 | 명령어 삭제 기능 추가 (ConsoleInput 자동완성) |
| **v1.0.3** | 2025.01.19 | 버전 동기화, Electron 서버 포트 8090으로 변경 |
| **v1.0.2** | 2025.01.12 | Context 편집 기능 추가 (사이드바에서 인라인 편집) |
...
[소개 사이트 →](https://www.devzip.site/commandstack){: .btn .btn-outline }
...
- [데모 사이트](https://devzip.site/commandstack)
