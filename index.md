...
<div class="project-card" style="background: white; border-radius: 15px; overflow: hidden; box-shadow: 0 5px 15px rgba(0,0,0,0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; position: relative; height: 100%;">
  ...
  <div style="padding: 20px;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 8px; margin-top: 15px;">
      <span style="background-color: #e3f2fd; color: #1565c0; padding: 5px 10px; border-radius: 5px; font-size: 0.8rem;">AWS</span>
      <span style="background-color: #e3f2fd; color: #1565c0; padding: 5px 10px; border-radius: 5px; font-size: 0.8rem;">HTML/CSS/JS</span>
      <span style="background-color: #e3f2fd; color: #1565c0; padding: 5px 10px; border-radius: 5px; font-size: 0.8rem;">Node.js</span>
      <span style="background-color: #e3f2fd; color: #1565c0; padding: 5px 10px; border-radius: 5px; font-size: 0.8rem;">React</span>
...
<!-- 모달 팝업 컨테이너 -->
<div id="pongdangModal" class="modal">
  <div class="modal-content">
    <span class="close-modal">&times;</span>
    <div class="modal-header">
      <h2>퐁당 매거진 웹사이트 개발 프로젝트</h2>
    </div>
    <div class="modal-body">
      <p>청소년들에게 세상에 있는 다양한 직업들을 소개해주는 웹매거진 '매거진 퐁당'의 풀스택 개발을 담당했습니다.</p>
      
      <div class="dev-challenge">
        <h3>개발 과정의 고민</h3>
        <p>웹 매거진의 특성상 다양한 콘텐츠 형식(글, 사진, 동영상)을 효과적으로 표현하면서도 빠른 로딩 속도를 유지해야 했습니다. 또한 사용자 경험을 고려하여 모바일 환경에서도 최적화된 반응형 디자인을 구현해야 했습니다.</p>
      </div>
      
      <div class="solution">
        <h3>해결 방안</h3>
        <p>백엔드에서는 Spring Boot를 활용하여 RESTful API를 구축하고, 프론트엔드에서는 React를 사용하여 사용자 인터페이스를 개발했습니다. 이미지 최적화를 위해 AWS S3와 CloudFront를 연동하여 이미지 로딩 속도를 개선했으며, 서버 부하를 분산시키기 위해 AWS EC2 인스턴스를 활용했습니다.</p>
      </div>
      ...
      <h3>개발 성과</h3>
      <p>사용자 친화적인 웹 매거진 플랫폼을 구축하여 다양한 콘텐츠를 효과적으로 전달할 수 있게 되었습니다. 특히 모바일 환경에서의 최적화를 통해 접근성을 크게 향상시켰으며, 효율적인 백엔드 아키텍처 설계로 안정적인 서비스 운영이 가능해졌습니다.</p>
...
<div id="cctvModal" class="modal">
  <div class="modal-content">
    <span class="close-modal">&times;</span>
    <div class="modal-header">
      <h2>어린이집 CCTV 영상처리 시스템</h2>
    </div>
    <div class="modal-body">
      <p>아동학대 방지를 위해 어린이집 내 CCTV 영상을 효율적으로 반출하고 학대 의심 구간을 탐지하는 시스템을 개발했습니다.</p>
      
      <div class="dev-challenge">
        <h3>개발 과정의 고민</h3>
        <p>CCTV 영상의 대용량 데이터를 어떻게 효율적으로 처리할 것인지, 그리고 아동학대 의심 구간을 어떻게 정확하게 탐지할 것인지가 주요 과제였습니다. 또한 영상 내 다른 아동들의 프라이버시 보호도 중요한 고려사항이었습니다.</p>
      </div>
      
      <div class="solution">
        <h3>해결 방안</h3>
        <p>영상 분석 알고리즘을 개발하여 소리, 움직임, 행동 패턴 등을 기반으로 학대 의심 구간을 자동으로 탐지하도록 구현했습니다. 또한 모자이크 처리 기능을 통해 특정 아동을 제외한 다른 아동들의 얼굴을 자동으로 가리도록 했습니다. 웹 인터페이스를 통해 사용자가 쉽게 영상을 검색하고 반출할 수 있는 시스템을 구축했습니다.</p>
      </div>
      ...
      <h3>개발 성과</h3>
      <p>아동학대 의심 구간을 빠르게 식별하고 반출할 수 있는 시스템을 구축함으로써, 수사기관의 조사 효율성을 높이고 아동학대 사건 해결에 기여했습니다. 또한 프라이버시 보호 기능을 통해 불필요한 개인정보 노출을 최소화했습니다.</p>
    </div>
  </div>
</div>
...
<div id="archiveModal" class="modal">
  <div class="modal-content">
    <span class="close-modal">&times;</span>
    <div class="modal-header">
      <h2>동국대학교 전자불전문화콘텐츠연구소 아카이브</h2>
    </div>
    <div class="modal-body">
      <p>동국대학교 전자불전문화콘텐츠연구소의 불교문화 관련 빅데이터를 저장하고 열람할 수 있는 홈페이지를 개발했습니다.</p>
      
      <div class="dev-challenge">
        <h3>개발 과정의 고민</h3>
        <p>방대한 양의 불교문화 콘텐츠를 효율적으로 관리하고 검색할 수 있는 시스템을 구축하는 것이 주요 과제였습니다. 특히 다양한 형태(이미지, 문서, 영상)의 자료를 체계적으로 분류하고 사용자가 쉽게 접근할 수 있도록 하는 것이 중요했습니다.</p>
      </div>
      
      <div class="solution">
        <h3>해결 방안</h3>
        <p>체계적인 데이터베이스 설계를 통해 복잡한 콘텐츠를 카테고리별로 분류하고, 효율적인 검색 시스템을 구현했습니다. 관리자 페이지를 통해 콘텐츠를 쉽게 업로드하고 관리할 수 있도록 했으며, 사용자 페이지에서는 직관적인 UI를 통해 원하는 자료를 빠르게 찾을 수 있도록 했습니다.</p>
      </div>
      ...
      <h3>개발 성과</h3>
      <p>연구소의 방대한 불교문화 콘텐츠를 체계적으로 관리하고 접근성을 높임으로써, 학술 연구 및 교육 자료로서의 활용도를 크게 향상시켰습니다. 또한 직관적인 인터페이스를 통해 일반 사용자들도 쉽게 불교문화 자료에 접근할 수 있게 되었습니다.</p>
    </div>
  </div>
</div>

<div id="vrLabModal" class="modal">
  <div class="modal-content">
    <span class="close-modal">&times;</span>
    <div class="modal-header">
      <h2>안전사고 예방과 과학 교육을 위한 VR실험실</h2>
    </div>
    <div class="modal-body">
      <p>실제 화학 실험에서의 위험사고와 경제적 손실을 최소화하기 위한 VR 가상 실험실 환경을 구현했습니다.</p>
      
      <div class="dev-challenge">
        <h3>개발 과정의 고민</h3>
        <p>실제 화학 실험을 얼마나 사실적으로 구현할 수 있을지, 그리고 교육적 효과를 최대화하기 위한 상호작용을 어떻게 설계할 것인지가 주요 과제였습니다. 또한 사용자가 VR 환경에서 직관적으로 실험을 수행할 수 있도록 하는 UI/UX 설계도 중요했습니다.</p>
      </div>
      
      <div class="solution">
        <h3>해결 방안</h3>
        <p>Unity 엔진을 활용하여 실제 화학 실험실과 유사한 환경을 3D로 구현하고, 사실적인 물리 엔진을 적용하여 실험 과정의 사실성을 높였습니다. 다양한 화학 반응을 시각적으로 구현하기 위해 파티클 시스템을 활용했으며, VR 컨트롤러를 통해 직관적인 조작이 가능하도록 설계했습니다.</p>
      </div>
      ...
      <div>
        ...
        <span class="tech-tag">VR 개발</span>
      </div>
      
      <h3>개발 성과</h3>
      <p>학생들이 안전한 환경에서 다양한 화학 실험을 경험할 수 있는 플랫폼을 구축함으로써, 실험 교육의 효율성과 안전성을 크게 향상시켰습니다. 특히 위험한 실험이나 고가의 장비가 필요한 실험도 VR 환경에서 자유롭게 수행할 수 있게 되어 교육적 효과를 극대화했습니다.</p>
    </div>
  </div>
</div>
